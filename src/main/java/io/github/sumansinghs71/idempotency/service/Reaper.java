 ...
 *
 * <p>Interval is configurable so tests can disable the timer and call
 * {@link #reap()} directly at a controlled moment.
 */
@Component
public class Reaper {
    ...
    @Scheduled(
            fixedDelayString = "${jobs.reaper.interval:PT1H}",
            initialDelayString = "${jobs.reaper.initial-delay:PT1M}")
    @Transactional
    public void reap() {
